...
## Please install the following packages running
...
results = 
  foreach (r = 1:replicate,
           .packages = c("Rlab","invgamma","MASS","LaplacesDemon","mvnfast","MCMCpack","Rcpp","RcppArmadillo")) %dopar% {
...
## Use Rcpp
sourceCpp("Rcpp.cpp")
results = Gibbs_Posterior(Group,M,T,X,Y,iteration = 100,burn = 20,chain = 1,p,n2,n,c)

## Use regular R code
## source("Gibbs_Ind.R")
source("Gibbs_Cor.R")
pos = Gibbs.Posterior(iteration  = 100, burn = 20, chain = 1)
