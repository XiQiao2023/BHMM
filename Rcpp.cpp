...
List Gibbs_Posterior(arma::mat Group, arma::mat M, arma::mat T, 
  ...
  for (int l = 0; l < chain; ++l) {
    ...
    arma::mat PIP_alphaT(iteration/2, p);
    arma::mat pos_alphaT(iteration/2, p);
    ...
    for (int i = 0; i < (iteration/2); ++i) {
      ...
      arma::mat diagp;
      Salpha0 = arma::iwishrnd(arma::inv(diagp.eye(p,p) + ssalpha0), p + n2);
      ...
      sigmaM = arma::iwishrnd(arma::inv(diagp.eye(p,p) + MSSR), p + n);
